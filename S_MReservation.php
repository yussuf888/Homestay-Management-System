...
mysql_select_db($database_MyHomeStay_System, $MyHomeStay_System);
$query_Recordset2 = "SELECT * FROM reservation natural join guest natural join homestay order by Date_Checkin DESC";
...
<form name="form1" method="post" action="S_MReservation.php">
                     <p align="center">
        ...
        <p>
                 ...
                 <?php  if(!isset($_POST['textfield1'])<="" && $row_Recordset1['Time']<="") {echo $index3="<p>Did not found reservation.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";} else { ?>      
                     ...
                     <table width="300" border="0">
                       <tr class="roomtype">
                         <td width="26%"><div align="left">Reservation ID</div></td>
                         <td width="33%"><div align="left">Guest Name</div></td>
                         <td width="16%"><div align="left">Date Checkin</div></td>
                         <td width="16%"><div align="left">Status</div></td>
                         <td width="9%">&nbsp;</td>
                       </tr>
                       <?php do { ?>
                       <tr>
                         ...
                         <td><div align="left"><?php echo $row_Recordset1['Status']; ?></div></td>
                         <td><a href="S_MVReservation.php?ID=<?php echo $row_Recordset1['Reservation_ID']; ?>" onclick="javascript:void window.open('S_MVReservation.php?ID=<?php echo $row_Recordset1['Reservation_ID']; ?>','1452488152659','width=950,height=800,toolbar=0,menubar=0,location=0,status=1,scrollbars=0,resizable=0,left=100,top=100,directories=no,location=no');return false;">View</a></td>
                       </tr>
                  ...
                  <table width="300" border="0">
                    <tr class="roomtype">
                       ...
                       <tr>
                           ...
                           <td><div align="left"><?php echo $row_Recordset2['Date_Checkin']; ?></div></td>
                           <td><div align="left"><?php echo $row_Recordset2['Status']; ?></div></td>
                           <td><a href="S_MVReservation.php?ID=<?php echo $row_Recordset2['Reservation_ID']; ?>" onclick="javascript:void window.open('S_MVReservation.php?ID=<?php echo $row_Recordset2['Reservation_ID']; ?>','1452488152659','width=950,height=800,toolbar=0,menubar=0,location=0,status=1,scrollbars=0,resizable=0,left=100,top=100,directories=no,location=no');return false;">View</a></td>
                         </tr>
