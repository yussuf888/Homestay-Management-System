...
$query_Recordset1 = sprintf("SELECT * FROM guest WHERE Guest_Name LIKE %s OR VERIFY = %s OR Guest_Email LIKE %s OR Guest_IC = %s", GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString($colname1_Recordset1, "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString($colname1_Recordset1, "text"));
...
mysql_select_db($database_MyHomeStay_System, $MyHomeStay_System);
$query_Recordset2 = "SELECT * FROM guest  ORDER BY Guest_Name DESC";
...
<li><a href="S_MRevenue.php">REVENUE</a></li><li><a onclick="return confirm('Press OK to logout.')" href="<?php echo $logoutAction ?>">LOGOUT</a></li>
...
<div id="homestay-sec" class="container set-pad" >
  <div class="row text-center">
               <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                 <h1 align="center" class="header-line" >GUEST</h1>
              
<form name="form1" method="post" action="S_Guest.php">
                     <p align="center">
                     <label for="textfield1"></label>
                     <input name="textfield1" type="text" class="textfield_Login widthregister searchreservation" placeholder="Verify Status/Name/ Email/ IC " id="textfield1" value="<?php echo isset($_POST['textfield1'])?$var=mysql_escape_string($_POST['textfield1']):$var=""; ?>">   
                           
        <p>
                       <input type="submit" class="btn btn-primary btn-lg searchreservation" name="btnSearch" id="btnSearch" value="Search"></form>
                 <?php  if(!isset($_POST['textfield1'])<="" && $row_Recordset1['Guest_Name']<="") {echo $index3="<p>Did not found guest.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";} else { ?>      
                         <?php  if (!empty($_POST)) { ?>   
                     <table width="300" border="0">
                       <tr class="roomtype">
                         <td width="28%"><div align="left">Guest Name</div></td>
                         <td width="29%"><div align="left">Guest Email</div></td>
                         <td width="20%"><div align="left">Identity Card No</div></td>
                         <td width="17%"><div align="left">Verification</div></td>
                         <td width="6%">&nbsp;</td>
                       </tr>
                       <?php do { ?>
                       <tr>
                         ...
                         <td><div align="left"><?php echo $row_Recordset1['Verify']; ?></div></td>
                         <td><a href="S_VGuest.php?Email=<?php echo $row_Recordset1['Guest_Email']; ?>" onclick="javascript:void window.open('S_VGuest.php?Email=<?php echo $row_Recordset1['Guest_Email']; ?>','1452488152659','width=600,height=640,toolbar=0,menubar=0,location=0,status=1,scrollbars=0,resizable=0,left=300,top=100,directories=no,location=no');return false;">View</a></td>
                       </tr>
                 ...
                 <p>                     
                  ...
                  <?php } else { ?> <tr>
                       ...
                       <?php do { ?>
                       <tr>
                         <td><div align="left"><?php echo $row_Recordset2['Guest_Name']; ?></div></td>
                         <td><div align="left"><?php echo $row_Recordset2['Guest_Email']; ?></div></td>
                         <td><div align="left"><?php echo $row_Recordset2['Guest_IC']; ?></div></td>
                         <td><div align="left"><?php echo $row_Recordset2['Verify']; ?></div></td>
                         <td><a href="S_VGuest.php?Email=<?php echo $row_Recordset2['Guest_Email']; ?>" onclick="javascript:void window.open('S_VGuest.php?Email=<?php echo $row_Recordset2['Guest_Email']; ?>','1452488152659','width=600,height=640,toolbar=0,menubar=0,location=0,status=1,scrollbars=0,resizable=0,left=300,top=100,directories=no,location=no');return false;">View</a></td>
                       </tr>
                         <?php } while ($row_Recordset2 = mysql_fetch_assoc($Recordset2)); ?>
                         <tr>
                         <td height="64" colspan="5"><div align="center">
                           <table width="82%" border="0" class="margintable1234" style="width:10%;">
                             <tr>
