...
<div id="homestay-sec" class="container" >
               ...
               <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                 ...
                 <table width="234%" height="182" border="0">
                             ...
                             <tr>
                               ...
                               <td><div align="left">
                                 : 
                                 <select name="Checkin" class="option1">
                                   <option value="YES" class="option1" <?php if (!(strcmp("YES", htmlentities($row_Recordset1['Checkin'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>YES</option>
                                   <option value="NO" class="option1" <?php if (!(strcmp("NO", htmlentities($row_Recordset1['Checkin'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>NO</option>
                                 </select>
                               </div></td>
                             </tr>
                   </table>
                 ...
                 <div align="right">
                   ...
                   <input type="hidden" name="Reservation_ID" value="<?php echo $row_Recordset1['Reservation_ID']; ?>" /><input type="submit" class="btn btn-primary btn-lg buttonRegister registerbutton1 rpayment table3 updatebutton1" value="Update" />
                   </div>
