...
$MM_restrictGoTo = "G_HomepageBlock.php";
...
<div id="homestay-sec" class="container set-pad" >
             <div class="row text-center">
               <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                 <h1 data-scroll-reveal="enter from the bottom after 0.3s" class="header-line">VERIFY YOUR EMAIL</h1>
                 <p data-scroll-reveal="enter from the bottom after 0.3s">Your account is not verified. Please verify your email to access to your account.</p>
                 <input data-scroll-reveal="enter from the bottom after 0.3s" type="submit" name="btnsubmit" id="btnsubmit" value="CLICK HERE TO RESEND VERIFICATION EMAIL" class="btn btn-primary btn-lg buttonRegister registerbutton1 rpayment" onClick="window.location='resend_verification.php'" />
