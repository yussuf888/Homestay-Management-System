...
?>
<meta http-equiv="refresh" content="0; URL='S_RPrint.php?Description=<?php echo $_GET['Description']?>&Checkin=<?php echo $_GET['Checkin']; ?>&Checkout=<?php echo $_GET['Checkout']; ?>'" />
