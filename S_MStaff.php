...
window.location.href='S_MStaff.php';
</script>";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="row text-center"><div class="col-lg-4  col-md-4 col-sm-4 widthreses"><p>&nbsp;</p><p>&nbsp;</p>
        ...
        <option value="Cleaner Department" <?php if (!(strcmp("Cleaner Department", ""))) {echo "SELECTED";} ?>>Cleaner Department</option>
            ...
            <tr valign="baseline">
              ...
              <input placeholder="Salary Per Hour" required="required" class="form-control form_control1" type="text" name="Salary_PerHour" value="" size="32" />
              <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
            </tr>
            <tr valign="baseline">
...
<span class="textfieldMinCharsMsg">Minimum number of characters not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.</span></span></td>
    ...
    <div class="col-lg-4  col-md-4 col-sm-4 widthreses">               
                 <p>&nbsp;</p><p>&nbsp;</p>
      <form name="form30" method="post" action="S_MStaff.php">
                     <p align="center">
                 ...
                 <?php  if (!empty($_POST)) { ?>
      <table width="300" border="0" class="margintable1234" align="center" style="margin-left:120px;">
                   <tr class="roomtype">
                     <td width="48%" height="44"><div align="left">Name</div></td>
                     <td width="52%"><div align="left">Identity Card No</div></td>
                   </tr>
        <?php do { ?>
                     <tr>
                       <td><div align="left"><?php echo $row_Recordset1['S_Name']; ?></div></td>
      ...
      <p>
        <?php } else {?>
                 ...
                 <table width="300" border="0" class="margintable1234" align="center" style="margin-left:120px;">
                   ...
                   <?php do { ?>
                     <tr>
                       <td><div align="left"><?php echo $row_Recordset2['S_Name']; ?></div></td>
                       <td><div align="left"><?php echo $row_Recordset2['S_IC']; ?></div></td>
                     </tr>
