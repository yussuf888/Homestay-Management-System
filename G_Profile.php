...
window.location.href='G_Profile.php';
</script>";
  if (isset($_SERVER['QUERY_STRING'])) {
                   ...
                   <div align="center">
                     ...
                     <tr valign="baseline">
                       ...
                       <td width="135" class="roomtype">Name</td>
                         ...
                         <input type="text" name="Guest_Name" placeholder="Name" class="form-control form_control1"  value="<?php echo htmlentities($row_Recordset1['Guest_Name'], ENT_COMPAT, 'utf-8'); ?>" size="32" required />
                       ...
                       <td width="135" class="roomtype">Birthday Date</td>
                         ...
                         <input type="date" required name="Guest_BirthDate" placeholder="Birthday Date (YYYY-MM-DD)" id="birthdate" class="form-control form_control1" value="<?php echo htmlentities($row_Recordset1['Guest_BirthDate'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
                         <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></div><input type="hidden" name="Guest_Gender" placeholder="Birthday Date (YYYY-MM-DD)" id="birthdate" class="form-control form_control1" value="<?php echo htmlentities($row_Recordset1['Guest_Gender'], ENT_COMPAT, 'utf-8'); ?>" size="32" required /></td>
                       </tr>
                      
                       <tr valign="baseline">
                       <td width="135" class="roomtype">Address</td>
                         <td><div align="center"><span id="sprytextarea1">
                           <textarea name="Guest_Address" required cols="50" placeholder="Address" class="form-control form_control1" rows="5" style="margin-top:-20px;"><?php echo $row_Recordset1['Guest_Address']; ?></textarea>
                       ...
                       <td width="135" class="roomtype">State</td>
                         ...
                         <input type="text" required name="Guest_State" placeholder="State" class="form-control form_control1" value="<?php echo htmlentities($row_Recordset1['Guest_State'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
                         <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldMinCharsMsg">Minimum number of characters not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.</span></span></div></td>
                       </tr>
                       <tr valign="baseline">
                       ...
                       <td width="135" class="roomtype">Phone</td>
                         ...
                         <input type="text" required name="Guest_PhoneNumber" placeholder="Phone Number" class="form-control form_control1" value="<?php echo htmlentities($row_Recordset1['Guest_PhoneNumber'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
                       ...
                       <td width="135" class="roomtype">Password</td>
                         <td><div align="center"><span id="sprytextfield8">
                           <input type="password" name="Guest_Password" id="password" placeholder="Password" required class="form-control form_control1" value="<?php echo htmlentities($row_Recordset1['Guest_Password'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
