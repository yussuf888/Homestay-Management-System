...
if ((isset($_GET['Expenses_ID'])) && ($_GET['Expenses_ID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM company_expenses WHERE Expense_ID=%s",
                       GetSQLValueString($_GET['Expenses_ID'], "int"));
