...
?>
<meta http-equiv="refresh" content="15; URL='G_RLogin.php'" />
  ...
  <tbody>
    <tr>
      <td><h1>EMAIL VERIFICATION</h1>
		...
		<p></p>
		<p>Please click on the link below to verify your email address and continue with your booking.</p>
		<p></p>
		
		<p><a href='localhost/G_Confirm.php?$random&email=$email' target='_blank'>localhost/G_Confirm.php?$random&email=$email</a></p>
		<p></p>
...
<div id="homestay-sec" class="container set-pad" >
                 ...
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                   <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line" >CONGRATULATIONS</h1>
                     <p data-scroll-reveal="enter from the bottom after 0.5s">Thanks for registering with SUNFLOWER HOUSE. Verification email has been sent to your email address . This page will redirect to log in page in 15 seconds.</p>
